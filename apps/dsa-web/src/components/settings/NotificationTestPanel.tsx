...
function getChannelOptions(language: UiLanguage): Array<{ value: NotificationTestChannel; label: string }> {
  ...
  return [
    { value: 'wechat', label: isEnglish ? 'WeCom' : isTraditional ? '企業微信' : '企业微信' },
    { value: 'feishu', label: isEnglish ? 'Feishu Webhook' : isTraditional ? '飛書 Webhook' : '飞书 Webhook' },
    { value: 'telegram', label: 'Telegram' },
    { value: 'email', label: isEnglish ? 'Email' : isTraditional ? '電子郵件' : '邮件' },
    { value: 'pushover', label: 'Pushover' },
    { value: 'ntfy', label: 'ntfy' },
    { value: 'gotify', label: 'Gotify' },
    { value: 'pushplus', label: 'PushPlus' },
    { value: 'serverchan3', label: 'ServerChan3' },
    { value: 'custom', label: isEnglish ? 'Custom Webhook' : isTraditional ? '自訂 Webhook' : '自定义 Webhook' },
