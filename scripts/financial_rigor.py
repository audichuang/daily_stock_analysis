#!/usr/bin/env python3
# Vendored from xbtlin/ai-berkshire (MIT License, Copyright (c) 2026 xbtlin).
# https://github.com/xbtlin/ai-berkshire — tools/financial_rigor.py
# Kept verbatim; zero external deps (stdlib only). Used by .claude/skills/value-research.
